	...
	<div class="firstPrimeContainer_ForMain">
	 <div class="secondPrimeContainer_ForMain">
			...
			<div class="middleContainer_ForMain">
								...
								<form action="${pageContext.request.contextPath}/admin/adminInsert.do"
									...
									<div class="Middle_ForMenu">
										...
										<c:forEach var="b" items="${memberList}">
											<div class="memberInfoList">
												...
												<div>
													<select name="dept" style="width : 90px;">
														<option value="pending">보류</option>
														<option value="admin">교육본부</option>
														<option value="member">영업본부</option>
														<option value="admin">개발본부</option>
														<option value="member">회계본부</option>
													</select>
												</div>
												<div>
													<select name="mtype" style="width : 70px;">
														<option value="admin">${b.mtype}</option>
										...
										<c:forEach var="b" items="${map.list}">
											<div class="memberInfoList">
												...
												<div>
													<select name="dept" style="width : 60px;">
														<option value="admin">관리자</option>
														<option value="member">회원</option>
													</select>
												</div>
												<div>
													<select name="mtype" style="width : 60px;">
														<option value="admin">관리자</option>
														<option value="member">회원</option>
													</select>
												</div>
